...
def main(args):
    ...
    # ckpt_path = "ckpts/{}-{}".format(args.dataset + args.ckpt, args.domain)
    # os.makedirs(ckpt_path, exist_ok=True)
    dataset, meta_info = GOODCMNIST.load(args.data_dir, domain=args.domain, shift="covariate", generate=False)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.ckpt and epoch % 10 == 0:
            torch.save(model.state_dict(), ckpt_path + "/epoch-{}-acc-{:.1f}.pt".format(epoch, test_cau))
...
if __name__ == "__main__":
    ...
    def arg_parse():
        ...
        parser.add_argument('--shift',     type=str,   default="covariate",   help='covariate, concept')
