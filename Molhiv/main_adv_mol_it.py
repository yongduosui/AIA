...
def main(args):
    ...
    dataset, meta_info = GOODHIV.load(args.data_dir, domain=args.domain, shift='covariate', generate=False)
    num_class = 1
    eval_metric = "rocauc"
    ...
    valid_loader_ood = DataLoader(dataset["val"],    batch_size=args.batch_size, shuffle=False, num_workers=0, worker_init_fn=_init_fn)
    test_loader_ood  = DataLoader(dataset["test"],   batch_size=args.batch_size, shuffle=False, num_workers=0, worker_init_fn=_init_fn)
